...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -608772867;

  static const kDefaultExternalLibraryLoaderConfig =
      ExternalLibraryLoaderConfig(
        stem: 'rust_lib_mechanix_terminal',
...
abstract class RustLibApi extends BaseApi {
  ...
  String? crateApiSimpleGetTerminalCwd({required int id});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  String? crateApiSimpleGetTerminalCwd({required int id}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiSimpleGetTerminalCwdConstMeta,
        argValues: [id],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiSimpleGetTerminalCwdConstMeta =>
      const TaskConstMeta(debugName: "get_terminal_cwd", argNames: ["id"]);
  ...
  void crateApiSimplePasteTerminal({required int id, required String input}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiSimplePasteTerminalConstMeta,
        argValues: [id, input],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiSimplePasteTerminalConstMeta =>
      const TaskConstMeta(
        debugName: "paste_terminal",
        argNames: ["id", "input"],
      );
  ...
  void crateApiSimpleResizeTerminal({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiSimpleResizeTerminalConstMeta,
  ...
  TaskConstMeta get kCrateApiSimpleResizeTerminalConstMeta =>
      const TaskConstMeta(
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_u_32(id, serializer);
          sse_encode_String(normalSeq, serializer);
          sse_encode_String(appSeq, serializer);
        ...
        constMeta: kCrateApiSimpleSendKeyConstMeta,
        argValues: [id, normalSeq, appSeq],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiSimpleSendKeyConstMeta => const TaskConstMeta(
    debugName: "send_key",
    argNames: ["id", "normalSeq", "appSeq"],
  );
